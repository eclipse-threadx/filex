...
/* Define basic alignment type used in block and byte pool operations. This data type must
   ...
   On Win32 (ILP32) ULONG is 32 bits and holds a pointer, so ULONG is sufficient.  */
...
CHAR                            _fx_version_id[] =
                                    "Copyright (c) 2026 Eclipse ThreadX contributors. * FileX Win32/Visual 6.5.1.202602 *";
#else
