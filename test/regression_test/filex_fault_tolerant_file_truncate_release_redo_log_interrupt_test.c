...
Step6: Create new thread to truncate TEST1.TXT file from 2048 to 26;
...
void    filex_fault_tolerant_file_truncate_release_redo_log_interrupt_test_application_define(void *first_unused_memory);
...
UINT        i;
    ...
    printf("FileX Test:   Fault Tolerant File Truncate R Redo LOG Interrupt Test.");
