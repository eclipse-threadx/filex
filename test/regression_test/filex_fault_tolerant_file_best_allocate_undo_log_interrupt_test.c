...
Check undo log interrupt for fx_file_best_effort_allocate():  
...
void    filex_fault_tolerant_file_best_allocate_undo_log_interrupt_test_application_define(void *first_unused_memory);
...
UINT        i;
    ...
    printf("FileX Test:   Fault Tolerant File Best Allo Undo LOG Interrupt Test..");
