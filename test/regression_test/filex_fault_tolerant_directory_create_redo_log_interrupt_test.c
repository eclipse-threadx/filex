...
Check redo log interrupt for fx_directory_create(): 
...
Step5: Create new thread to create new directory "/D0/D5";
...
Step10: Recreate directory "/D0/D5"; 
*/
...
void    filex_fault_tolerant_directory_create_redo_log_interrupt_test_application_define(void *first_unused_memory);
...
UINT        i;
    ...
    printf("FileX Test:   Fault Tolerant Dir Create Redo LOG Interrupt Test......");        
...
#endif
{
    ...
    /* Print out some test information banners.  */
    printf("FileX Test:   Fault Tolerant Dir Create Redo LOG Interrupt Test......N/A\n");
