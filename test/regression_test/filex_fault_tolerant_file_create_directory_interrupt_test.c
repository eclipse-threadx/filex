...
void    filex_fault_tolerant_file_create_directory_interrupt_test_application_define(void *first_unused_memory);
...
UINT        i;
    ...
    printf("FileX Test:   Fault Tolerant File Create DIR Interrupt Test..........");
    ...
    for (i = 0; i < TEST_COUNT; i ++)
    {
        ...
        /* Open the test file.  */
        status =  fx_file_open(&ram_disk, &my_file, "TEST3.TXT", FX_OPEN_FOR_WRITE);
...
#endif
{
    ...
    fx_file_create(&ram_disk, "TEST3.TXT");
}
