...
Check redo interrupt for fx_file_write() :    
...
Step7: Terminate the new thread to simulate poweroff when write redo log.  
...
void    filex_fault_tolerant_file_write_redo_log_interrupt_test_application_define(void *first_unused_memory);
...
ULONG       actual;          
    ...
    printf("FileX Test:   Fault Tolerant File Write Redo LOG Interrupt Test......");
