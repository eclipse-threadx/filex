...
Check fat interrupt for fx_file_truncate_release():  
...
void    filex_fault_tolerant_file_truncate_release_fat_interrupt_test_application_define(void *first_unused_memory);
...
UINT        i;
    ...
    printf("FileX Test:   Fault Tolerant File Truncate R FAT Interrupt Test......");
...
#endif
{
    ...
    /* Truncate the "TEST1.TXT" file from 1024 to 26.  */
