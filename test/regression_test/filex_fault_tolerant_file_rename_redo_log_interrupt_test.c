...
Check redo log interrupt for fx_file_rename():  
...
void    filex_fault_tolerant_file_rename_redo_log_interrupt_test_application_define(void *first_unused_memory);
...
UINT        i;
    ...
    printf("FileX Test:   Fault Tolerant File Rename Redo LOG Interrupt Test.....");
