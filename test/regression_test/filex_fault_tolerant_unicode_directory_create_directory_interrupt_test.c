...
Check directory interrupt for fx_unicode_directory_create():  
...
Step5: Create new thread to create new directory "/B/B2/B22/B222";
...
Step10: Recreate directory "/B/B2/B22/B222"; 
*/
...
void    filex_fault_tolerant_unicode_directory_create_directory_interrupt_test_application_define(void *first_unused_memory);
...
static UCHAR                  directory_name_B_B2_B22_B222[] =  {'B', 0, '2', 0, '2', 0, '2', 0, 0, 0};
...
static CHAR                   directory_name_B_B2_B22_B222_short[20];
static CHAR                   directory_name_path_short[100];

static UINT                   expected_index =  0;
static CHAR                   **expected_name;
static CHAR *expected_name_0[] = { "A", ".", "..", "A1", ".", "..", "A11", ".", "..", "A2", ".", "..", "A3", ".", "..", "B", ".", "..", "B1", ".",
 "..", "B2", ".", "..", "B22", ".", "..", "B3", ".", "..", "C", ".", "..", "C1", ".", "..", "C2", ".", "..",  "C3", ".", "..", "C33", ".", "..", "END"}; 
static CHAR *expected_name_1[] =  { "A", ".", "..", "A1", ".", "..", "A11", ".", "..", "A2", ".", "..", "A3", ".", "..",  "B", ".", "..", "B1", ".", "..",
 "B2", ".", "..", "B22", ".", "..", "B222", ".", "..", "B3", ".", "..", "C", ".", "..", "C1", ".", "..", "C2", ".", "..", "C3", ".", "..", "C33", ".",
 "..", "END"};   
...
FX_LOCAL_PATH   local_path;
    ...
    printf("FileX Test:   Fault Tolerant Unicode Dir Create DIR Interrupt Test...");
    ...
    for (i = 0; i < TEST_COUNT; i ++)
    {
        ...
        status =   fx_directory_default_set(&ram_disk, directory_name_path_short);
#endif
        length = fx_unicode_length_get(directory_name_B_B2_B22_B222);
        status = fx_unicode_directory_create(&ram_disk, directory_name_B_B2_B22_B222, length, directory_name_B_B2_B22_B222_short);
        return_if_fail( status == FX_ALREADY_CREATED);

        /* Close the media.  */
        status =  fx_media_close(&ram_disk);
        return_if_fail( (status == FX_SUCCESS) && (directory_write_interrupt == FX_TRUE) && (error_counter == 0));
...
FX_LOCAL_PATH   local_path;
    ...
    /* Construct the directory structure /B/B2/B22.  */
    for(j = 0; j < 20; j ++)
    {

        /* Check the value.  */
        if (directory_name_B_B2_B22_short[j])
        {
            directory_name_path_short[index++] = directory_name_B_B2_B22_short[j];
        }
        else
        {
            break;
...
#endif
    length = fx_unicode_length_get(directory_name_B_B2_B22_B222);
    fx_unicode_directory_create(&ram_disk, directory_name_B_B2_B22_B222, length, directory_name_B_B2_B22_B222_short); 
}
