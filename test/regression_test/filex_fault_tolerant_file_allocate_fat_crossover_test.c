...
Step6: Create a new thread and allocate cluster 127 and 128 for A.TXT.
...
ULONG       errors_detected;
    ...
    printf("FileX Test:   Fault Tolerant File Allocate Fat Crossover Test........");
...
#endif
{
    ...
    */
    fx_file_allocate(&my_file, 512 * 2);
}
...
#endif
{
    ...
    /* Print out some test information banners.  */
    printf("FileX Test:   Fault Tolerant File Allocate Fat Crossover Test........N/A\n");
