...
Check directory interrupt for fx_unicode_file_rename():    
...
Step7: Terminate the new thread to simulate poweroff when update the directory after record the redo log.  
...
void    filex_fault_tolerant_unicode_file_rename_directory_interrupt_test_application_define(void *first_unused_memory);
...
UINT        length;
    ...
    printf("FileX Test:   Fault Tolerant File Unicode Rename DIR Interrupt Test..");
