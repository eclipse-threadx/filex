...
Check directory interrupt for fx_unicode_file_create() :         
...
Step7: Terminate the new thread to simulate poweroff when update directory.  
...
void    filex_fault_tolerant_unicode_file_create_directory_interrupt_test_application_define(void *first_unused_memory);
...
UINT        length;
    ...
    printf("FileX Test:   Fault Tolerant Unicode File Create DIR Interrupt Test..");
