...
Check directory interrupt for fx_file_delete():    
...
void    filex_fault_tolerant_file_delete_directory_interrupt_test_application_define(void *first_unused_memory);
...
UINT        i;
    ...
    printf("FileX Test:   Fault Tolerant File Delete DIR Interrupt Test..........");
