...
void    filex_fault_tolerant_directory_create_directory_interrupt_test_application_define(void *first_unused_memory);
...
UINT        i;
    ...
    printf("FileX Test:   Fault Tolerant Dir Create DIR Interrupt Test...........");
