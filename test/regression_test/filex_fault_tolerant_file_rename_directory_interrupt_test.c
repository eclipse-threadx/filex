...
Check directory interrupt for fx_file_rename():    
...
Step6: Create new thread to rename TEST2.TXT to TEST21.TXT;
...
void    filex_fault_tolerant_file_rename_directory_interrupt_test_application_define(void *first_unused_memory);
...
UINT        i;
    ...
    printf("FileX Test:   Fault Tolerant File Rename DIR Interrupt Test..........");
    ...
    for (i = 0; i < TEST_COUNT; i ++)
    {
        ...
        /* Open the test file.  */
        status =  fx_file_open(&ram_disk, &my_file, "TEST21.TXT", FX_OPEN_FOR_WRITE);
...
#endif
{
    ...
    fx_file_rename(&ram_disk, "TEST2.TXT", "TEST21.TXT");
}
