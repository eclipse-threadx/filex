...
void    filex_fault_tolerant_unicode_directory_create_redo_log_interrupt_test_application_define(void *first_unused_memory);
...
#endif
{
    ...
    /* Print out some test information banners.  */
    printf("FileX Test:   Fault Tolerant Unicode Dir Create Redo Interrupt Test..N/A\n");
