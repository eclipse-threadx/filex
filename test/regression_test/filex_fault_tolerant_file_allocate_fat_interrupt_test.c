...
Check fat interrupt for fx_file_allocate(): 
...
void    filex_fault_tolerant_file_allocate_fat_interrupt_test_application_define(void *first_unused_memory);
...
#endif
{
   ...
   // pthread_create(&ptid0, NULL, &ftest_0_entry, NULL);
   ftest_0_entry(0);
#endif
}
...
UINT        i;
    ...
    printf("FileX Test:   Fault Tolerant File Allocate FAT Interrupt Test........");
...
{     
    ...
    /* Allocate 1500 size...  */
    status = fx_file_allocate(&my_file, 1500);        
}
