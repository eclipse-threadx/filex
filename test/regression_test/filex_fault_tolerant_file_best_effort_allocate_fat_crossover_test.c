...
Step6: Create a new thread and allocate cluster 127 and 128 for A.TXT(by fx_file_best_effort_allocate).
...
ULONG       errors_detected;
    ...
    printf("FileX Test:   Fault Tolerant File Best Effort Allocate FAT Crossover Test.");
...
#endif
{
    ...
    */
    fx_file_best_effort_allocate(&my_file, 512 * 2, &actual_size);
}
...
#endif
{
    ...
    /* Print out some test information banners.  */
    printf("FileX Test:   Fault Tolerant File Best Effort Allocate FAT Crossover Test.N/A\n");
