...
void    filex_fault_tolerant_file_create_redo_log_interrupt_test_application_define(void *first_unused_memory);
...
UINT        i;
    ...
    printf("FileX Test:   Fault Tolerant File Create Redo LOG Interrupt Test.....");
