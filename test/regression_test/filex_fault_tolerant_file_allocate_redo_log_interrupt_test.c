...
Check redo log interrupt for fx_file_allocate():   
...
Step9: Enable fault tolerant feature to do undo operation;    
...
void    filex_fault_tolerant_file_allocate_redo_log_interrupt_test_application_define(void *first_unused_memory);
...
UINT        i;
    ...
    printf("FileX Test:   Fault Tolerant File Allocate Redo LOG Interrupt Test...");
