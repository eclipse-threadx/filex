...
Step5: Create new thread to rename directory from "/D0/D4" to "/D0/D5";
...
Step9: Create directory "/D0/D4";   
Step10: Create directory "/D0/D5";   
*/
...
void    filex_fault_tolerant_directory_rename_directory_interrupt_test_application_define(void *first_unused_memory);
...
UINT        i;
    ...
    printf("FileX Test:   Fault Tolerant Dir Rename DIR Interrupt Test...........");
    ...
    for (i = 0; i < TEST_COUNT; i ++)
    {
        ...
        /* Attempt to create the "/D0/D4" directory again.  */
        status = fx_directory_create(&ram_disk, "/D0/D4");
        ...
        /* Attempt to create the "/D0/D5" directory again.  */
        ...
        if ((status != FX_SUCCESS) || (directory_write_interrupt != FX_TRUE) || (error_counter))
        {
...
{     
    ...
    /* Set the callback function to simulate poweoff operation.  */
    driver_write_callback = my_driver_write;
                                                          
    /* Rename the directory "/D0/D4" to "/D0/D5".  */
    fx_directory_rename(&ram_disk, "/D0/D4", "/D0/D5");
}
