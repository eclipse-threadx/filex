...
Step7: Terminate the new thread to simulate poweroff when update the directory.  
...
void    filex_fault_tolerant_file_truncate_release_directory_interrupt_test_application_define(void *first_unused_memory);
...
UINT        i;
    ...
    printf("FileX Test:   Fault Tolerant File Truncate R DIR Interrupt Test......");
...
static UINT my_driver_write(FX_MEDIA *media_ptr, UINT sector_type, UCHAR *block_ptr, UINT *operation_ptr)
{
    ...
    /* Interrupt the Directory write operation after record the log.  */
...
#endif
{
    ...
    /* Print out some test information banners.  */
    printf("FileX Test:   Fault Tolerant File Truncate R DIR Interrupt Test......N/A\n");
