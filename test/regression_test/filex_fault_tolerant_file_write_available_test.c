...
void    filex_fault_tolerant_file_write_available_test_application_define(void *first_unused_memory);
...
static UINT my_driver_write(FX_MEDIA *media_ptr, UINT sector_type, UCHAR *block_ptr, UINT *operation_ptr)
{
    ...
    if ((sector_type == FX_DATA_SECTOR) && (_filex_fault_tolerant_log_check(media_ptr) & FX_FAULT_TOLERANT_LOG_REDO_DONE))
    {
...
#endif
{
    ...
    /* Print out some test information banners.  */
    printf("FileX Test:   Fault Tolerant File Write Available Test...............N/A\n");
