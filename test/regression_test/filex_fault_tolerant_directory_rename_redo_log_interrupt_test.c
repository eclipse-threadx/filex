...
void    filex_fault_tolerant_directory_rename_redo_log_interrupt_test_application_define(void *first_unused_memory);
...
UINT        i;
    ...
    printf("FileX Test:   Fault Tolerant Dir Rename Redo LOG Interrupt Test......");
...
#endif
{
    ...
    fx_directory_create(&ram_disk, "/D0/D5");
}
