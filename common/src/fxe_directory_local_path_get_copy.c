...
/*  FUNCTION                                               RELEASE        */
/*                                                                        */
/*    _fxe_directory_local_path_get_copy                  PORTABLE C      */
/*                                                           6.1          */
/*  AUTHOR                                                                */
/*                                                                        */
...
/*  DESCRIPTION                                                           */
/*                                                                        */
/*    This function checks for errors in the local path get copy call.    */
/*                                                                        */
/*  INPUT                                                                 */
/*                                                                        */
...
UINT status;
    ...
    status =  _fx_directory_local_path_get_copy(media_ptr, return_path_name_buffer, return_path_name_buffer_size);
