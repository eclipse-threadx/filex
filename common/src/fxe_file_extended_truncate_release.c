...
/*  FUNCTION                                               RELEASE        */
/*                                                                        */
/*    _fxe_file_extended_truncate_release                 PORTABLE C      */
/*                                                           6.1          */
/*  AUTHOR                                                                */
/*                                                                        */
...
/*  CALLS                                                                 */
/*                                                                        */
/*    _fx_file_extended_truncate_release    Actual file truncate release  */
/*                                            service                     */
/*                                                                        */
/*  CALLED BY                                                             */
/*                                                                        */
...
UINT status;
    ...
    status =  _fx_file_extended_truncate_release(file_ptr, size);
